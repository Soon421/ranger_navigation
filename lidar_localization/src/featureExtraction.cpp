...
public:
    ...
    rclcpp::Subscription<lidar_localization::msg::CloudInfo>::SharedPtr subLaserCloudInfo;

    rclcpp::Publisher<lidar_localization::msg::CloudInfo>::SharedPtr pubLaserCloudInfo;
    ...
    pcl::CustomVoxelGrid<PointType> downSizeFilter;
    ...
    FeatureExtraction(const rclcpp::NodeOptions & options) :
        ParamServer("lidar_localization_featureExtraction", options)
    {
        subLaserCloudInfo = create_subscription<lidar_localization::msg::CloudInfo>(
            "lidar_localization/deskew/cloud_info", qos,
            std::bind(&FeatureExtraction::laserCloudInfoHandler, this, std::placeholders::_1));

        pubLaserCloudInfo = create_publisher<lidar_localization::msg::CloudInfo>(
            "lidar_localization/feature/cloud_info", qos);
        pubCornerPoints = create_publisher<sensor_msgs::msg::PointCloud2>(
            "lidar_localization/feature/cloud_corner", 1);
        pubSurfacePoints = create_publisher<sensor_msgs::msg::PointCloud2>(
            "lidar_localization/feature/cloud_surface", 1);
